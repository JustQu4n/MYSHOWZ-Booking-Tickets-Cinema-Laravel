...
<head>
	...
	<title>Signin</title>
	<link rel="stylesheet" type="text/css" href="{{ asset('client/assets/css/as-alert-message.min.css') }}">
	<link rel="stylesheet" type="text/css"
		href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.14.0/css/all.min.css">
	<link rel="stylesheet" type="text/css" href="{{ asset('client/assets/css/style-starter.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('client/assets/css/sign-in.css') }}">
</head>
@if ($errors->any())
        <div>
            <ul>
...
<body>
	...
	<div class="container_signup_signin" id="container_signup_signin">
		...
		<div class="form-container sign-in-container">
			<form method="POST" name="sign-in-form" style="color: var(--theme-title);" action="{{ route('login') }}"
				...
				<input ntype="password" name="password" required placeholder="Password" />
	...
	<script type="text/javascript" src="{{ asset('client/assets/js/as-alert-message.min.js') }}"></script>
	<script src="{{ asset('client/assets/js/jquery-3.3.1.min.js') }}"></script>
	<!--/theme-change-->
	<script src="{{ asset('client/assets/js/theme-change.js') }}"></script>
	...
	<script type="text/javascript" src="{{ asset('client/assets/js/sign-in.js') }}"></script>
